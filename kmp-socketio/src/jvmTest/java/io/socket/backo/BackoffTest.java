...
import com.piasy.kmp.socketio.socketio.Backoff;
...
public class BackoffTest {
    ...
    public void durationShouldIncreaseTheBackoff() {
        ...
        assertTrue(100 == b.getDuration());
        assertTrue(200 == b.getDuration());
        assertTrue(400 == b.getDuration());
        assertTrue(800 == b.getDuration());
    ...
    public void durationOverflow() {
        for (int i = 0; i < 10; i++) {
            ...
            for (int j = 0; j < 100; j++) {
                ...
                BigInteger duration = BigInteger.valueOf(b.getDuration());
